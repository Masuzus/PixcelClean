...
下面两张透明 PNG 由同一张 `256 × 256` 原图导出，可直接比较两个版本的背景清除和主体保留效果。

| Pixel Clean 1.0 | Pixel Clean 2.0 Alpha |
| :---: | :---: |
| ![Pixel Clean 1.0 导出的透明像素图](docs/images/pixel-clean-processed.png) | ![Pixel Clean 2.0 Alpha 导出的透明像素图](docs/images/pixel-clean-processed-2.0.png) |
| 边缘残留较多，局部线条和色块不够连贯 | **背景清除更完整，主体线条更清晰连贯** |

**直观变化：** 2.0 清除了更多内外背景以及辉光边缘残留，同时将更多主体像素保留为清晰的不透明线条，仅在确实需要柔和过渡的位置保留连续 Alpha。
...
<p align="center">
  <img src="docs/images/pixel-clean-source.png" width="256" alt="统一深色背景上的原始像素图">
</p>
